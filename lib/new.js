...
function getThemeOptions(theme, callback) {
  request({
    ...
    cabinJSON.style.forEach(function (style) {
      var option = {};
      option[userOptions.style[style.toLowerCase()].optionName] = userOptions.style[style.toLowerCase()].taskName;
    ...
    cabinJSON.template.forEach(function (template) {
      ...
      option[userOptions.template[template.toLowerCase()].optionName] = userOptions.template[template.toLowerCase()].taskName;
